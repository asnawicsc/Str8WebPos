defmodule WebposWeb.UserControllerTest do
  use WebposWeb.ConnCase

  alias Webpos.Settings

  @create_attrs %{crypted_password: "some crypted_password", email: "some email", password: "some password", username: "some username"}
